...
extern "C"  void WorldManager_resetScene_m4262194985 (WorldManager_t3626441138 * __this, const RuntimeMethod* method)
{
	...
	memset(&V_1, 0, sizeof(V_1));
	{
		...
		intptr_t L_0 = V_1;
		// ARKitWorldTrackingSessionConfiguration sessionConfig = new ARKitWorldTrackingSessionConfiguration(UnityARAlignment.UnityARAlignmentGravity, UnityARPlaneDetection.Horizontal, false, true, true);
		ARKitWorldTrackingSessionConfiguration__ctor_m1870194359((ARKitWorldTrackingSessionConfiguration_t273386347 *)(&V_0), 0, 1, (bool)0, (bool)1, (bool)1, L_0, (String_t*)NULL, /*hidden argument*/NULL);
